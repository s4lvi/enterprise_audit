...
import { createChapterCheckItem } from "../actions";

export default async function NewChapterCheckItemPage() {
  ...
  return (
    <main className="mx-auto mt-8 w-full max-w-2xl px-4 sm:px-6 lg:px-8">
      ...
      <CheckItemForm action={createChapterCheckItem} submitLabel="Create item" />
    </main>
  );
}
